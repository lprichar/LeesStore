...
namespace LeesStore.Migrations
{
    ...
    [Migration("20200514215220_Update-AbpUsers-SetDiscriminator")]
    partial class UpdateAbpUsersSetDiscriminator
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeesStore.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LeesStore.Authorization.ApiKeys.ApiKey", b =>
                {
                    b.HasBaseType("LeesStore.Authorization.Users.User");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("LeesStore.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("LeesStore.Authorization.Users.User", null)
                        .WithMany("Claims")
