...
{
    public abstract class LeesStoreWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LeesStoreWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LeesStoreWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LeesStoreDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LeesStoreDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LeesStoreDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LeesStoreDbContext, Task<T>> func)
        {
            T result;
